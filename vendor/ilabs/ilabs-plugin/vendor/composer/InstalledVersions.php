 ...
 */
namespace Isolated\BlueMedia\Composer;

use Isolated\BlueMedia\Composer\Autoload\ClassLoader;
use Isolated\BlueMedia\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('Isolated\\BlueMedia\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
